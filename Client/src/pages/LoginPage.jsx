            ...
            <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex
                ...
                <div className='flex flex-col gap-2'>
                    {currState === "Sign up" ? (
                        ...
                        className='font-medium text-violet-500 cursor-pointer' onClick={()=>{setCurrState('Login'); setIsDataSubmitted(false)}}>Login here
                        </span></p>
                    ) : (
                        <p className='text-sm text-gray-600'>Don't have an account? <span 
                        className='font-medium text-violet-500 cursor-pointer' onClick={()=>setCurrState('Sign up')}>Sign up here
                        </span></p>
                    )}
                </div>
            </form>
